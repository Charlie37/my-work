...
bl_info = {
    'name': 'Layer Name',
    'author': 'Arnaud Trouve, Alfonso Annarumma',
    'version': (1,4),
    'blender': (2, 7, 0),
    'location': 'View3D > Properties panel > Layers',
    'warning': '',
    'description': 'Display and Edit Layer Name. Default rename.',
    'wiki_url': '',
    'tracker_url': '',
    'category': '3D View'}
...
class LockSelected(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if view_3d.layers_used[layerN] or True in groups:
    ...
    def execute(self, context):
        ...
        if view_3d.layers_used[layerN]:
            ...
            for obj in context.scene.objects:
                ...
                if obj.layers[layerN]:
                    obj.select=not select_obj
                    
                    
                    
                    scene.ObjectSelect[layerN]= not select_obj
...
class LayerName(bpy.types.Panel):
    ...
    bpy.types.Scene.LayerName1 = bpy.props.StringProperty(name="Layer Name", default='corbeau_corps')
    bpy.types.Scene.LayerName2 = bpy.props.StringProperty(name="Layer Name", default='corbeau_PATTES_BEC')
    bpy.types.Scene.LayerName3 = bpy.props.StringProperty(name="Layer Name", default='BEC_INT')
    bpy.types.Scene.LayerName4 = bpy.props.StringProperty(name="Layer Name", default='AILES_CLOSED')
    bpy.types.Scene.LayerName5 = bpy.props.StringProperty(name="Layer Name", default='BUSTE')
    bpy.types.Scene.LayerName6 = bpy.props.StringProperty(name="Layer Name", default='DECOR')
    ...
    bpy.types.Scene.LayerName11 = bpy.props.StringProperty(name="Layer Name", default='RIG')
    ...
    bpy.types.Scene.LayerName16 = bpy.props.StringProperty(name="Layer Name", default='LIGHTING_corbeau')
    bpy.types.Scene.LayerName17 = bpy.props.StringProperty(name="Layer Name", default='LIGHTING_Socle')
    ...
    #lock layer status
    bpy.types.Scene.LockLayer = bpy.props.BoolVectorProperty(name="Lock Layer", default = (False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False), size=20)
    
    #Select object Status
    bpy.types.Scene.ObjectSelect = bpy.props.BoolVectorProperty(name="Object Select", default = (False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False), size=20)
    ...
    def draw(self, context):
        ...
        allView = row3.operator("scene.layersselect", icon=allIcon, emboss= False, text=allText)
        allView.vis=vis
        
        #lock camera and layers button 
           
        row3.prop(view_3d, "lock_camera_and_layers", text="")
        row3.split()
